...
namespace WebApp.Controllers
{
    ...
    {
        private readonly EmployeeDeptContext _context;

        public DepartmentsController(EmployeeDeptContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Department>> PostDepartment(Department department)
        {
          if (_context.Departments == null)
          {
              return Problem("Entity set 'EmployeeDeptContext.Departments'  is null.");
          }
